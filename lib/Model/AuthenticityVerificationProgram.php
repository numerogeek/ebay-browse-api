...
class AuthenticityVerificationProgram implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description An indication that the item is from a verified seller.
     *
     * @return self
     */
     ...
     * Sets terms_web_url
     *
     * @param string|null $terms_web_url The URL to the Authenticity Verification program terms of use.
     *
     * @return self
     */
