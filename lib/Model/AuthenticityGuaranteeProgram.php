...
/**
 * AuthenticityGuaranteeProgram Class Doc Comment
 *
 * @category Class
 ...
 */
class AuthenticityGuaranteeProgram implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthenticityGuaranteeProgram';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description An indication that the item is qualified for the Authenticity Guarantee program.
     *
     * @return self
     */
     ...
     * Sets terms_web_url
     *
     * @param string|null $terms_web_url The URL to the Authenticity Guarantee program terms of use.
     *
     * @return self
     */
