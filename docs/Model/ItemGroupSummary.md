...
------------ | ------------- | ------------- | -------------
**item_group_additional_images** | [**\OpenAPI\EbayBrowseClient\Model\Image[]**](Image.md) | An array of containers with the URLs for images that are in addition to the primary image of the item group.  The primary image is returned in the &lt;b&gt; itemGroupImage&lt;/b&gt; field. | [optional]
...
**item_group_image** | [**\OpenAPI\EbayBrowseClient\Model\Image**](Image.md) |  | [optional]
