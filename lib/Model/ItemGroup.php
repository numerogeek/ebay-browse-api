...
class ItemGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'items' => '\OpenAPI\EbayBrowseClient\Model\Item[]',
    ...
    {
        $this->setIfExists('common_descriptions', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \OpenAPI\EbayBrowseClient\Model\CommonDescriptions[]|null
     */
     ...
     *
     * @param \OpenAPI\EbayBrowseClient\Model\CommonDescriptions[]|null $common_descriptions An array of containers for a description and the item IDs of all the items that have this exact description. Often the item variations within an item group all have the same description. Instead of repeating this description in the item details of each item, a description that is shared by at least one other item is returned in this container. If the description is unique, it is returned in the <b> items.description</b> field.
     *
     * @return self
     */
    public function setCommonDescriptions($common_descriptions)
    {
        if (is_null($common_descriptions)) {
            throw new \InvalidArgumentException('non-nullable common_descriptions cannot be null');
        }
     ...
     * Gets items
     *
     * @return \OpenAPI\EbayBrowseClient\Model\Item[]|null
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\EbayBrowseClient\Model\Item[]|null $items An array of containers for all the item variation details, excluding the description.
     *
     * @return self
     */
