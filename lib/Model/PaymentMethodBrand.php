...
/**
 * PaymentMethodBrand Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\EbayBrowseClient
 * @author   OpenAPI Generator team
 ...
 */
class PaymentMethodBrand implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentMethodBrand';
    ...
    protected static $openAPITypes = [
        ...
        'logo_image' => '\OpenAPI\EbayBrowseClient\Model\Image'
    ];
    ...
    protected static $openAPIFormats = [
        'payment_method_brand_type' => null,
        'logo_image' => null
    ];
    ...
    protected static array $openAPINullables = [
        'payment_method_brand_type' => false,
		'logo_image' => false
    ];
    ...
    protected static $setters = [
        'payment_method_brand_type' => 'setPaymentMethodBrandType',
    ...
    protected static $getters = [
        'payment_method_brand_type' => 'getPaymentMethodBrandType',
    ...
    {
        $this->setIfExists('payment_method_brand_type', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets payment_method_brand_type
     *
     * @return string|null
     */
    public function getPaymentMethodBrandType()
    {
        return $this->container['payment_method_brand_type'];
    }

    /**
     * Sets payment_method_brand_type
     *
     * @param string|null $payment_method_brand_type The payment method brand, such as Visa or PayPal. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/browse/types/gct:PaymentMethodBrandEnum'>eBay API documentation</a>
     *
     * @return self
     */
    public function setPaymentMethodBrandType($payment_method_brand_type)
    {
        if (is_null($payment_method_brand_type)) {
            throw new \InvalidArgumentException('non-nullable payment_method_brand_type cannot be null');
        }
        $this->container['payment_method_brand_type'] = $payment_method_brand_type;
     ...
     * Sets logo_image
     *
     * @param \OpenAPI\EbayBrowseClient\Model\Image|null $logo_image logo_image
     *
     * @return self
     */
