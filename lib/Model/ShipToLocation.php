 ...
 */
class ShipToLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code The zip code (postal code) for where the item is to be shipped.
     *
     * @return self
     */
