...
class ItemSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'categories' => '\OpenAPI\EbayBrowseClient\Model\Category[]',
        'compatibility_match' => 'string',
        'compatibility_properties' => '\OpenAPI\EbayBrowseClient\Model\CompatibilityProperty[]',
        'condition' => 'string',
        'condition_id' => 'string',
        'current_bid_price' => '\OpenAPI\EbayBrowseClient\Model\ConvertedAmount',
        'distance_from_pickup_location' => '\OpenAPI\EbayBrowseClient\Model\TargetLocation',
        ...
        'item_href' => 'string',
        'item_id' => 'string',
        'item_location' => '\OpenAPI\EbayBrowseClient\Model\ItemLocationImpl',
        'item_web_url' => 'string',
        'leaf_category_ids' => 'string[]',
        'legacy_item_id' => 'string',
        'listing_marketplace_id' => 'string',
        'marketing_price' => '\OpenAPI\EbayBrowseClient\Model\MarketingPrice',
        'pickup_options' => '\OpenAPI\EbayBrowseClient\Model\PickupOptionSummary[]',
        ...
        'seller' => '\OpenAPI\EbayBrowseClient\Model\Seller',
        'shipping_options' => '\OpenAPI\EbayBrowseClient\Model\ShippingOptionSummary[]',
        'short_description' => 'string',
        'thumbnail_images' => '\OpenAPI\EbayBrowseClient\Model\Image[]',
        'title' => 'string',
    ...
    */
     ...
     * Gets categories
     *
     * @return \OpenAPI\EbayBrowseClient\Model\Category[]|null
     */
     ...
     * Sets categories
     *
     * @param \OpenAPI\EbayBrowseClient\Model\Category[]|null $categories This array returns the name and ID of each category associated with the item, including top level, branch, and leaf categories.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\EbayBrowseClient\Model\CompatibilityProperty[]|null
     */
     ...
     * Sets condition_id
     *
     * @param string|null $condition_id The identifier of the condition of the item. For example, 1000 is the identifier for NEW. For a list of condition names and IDs, see <a href=\"/devzone/finding/callref/enums/conditionIdList.html \" target=\"_blank\">Item Condition IDs and Names</a>. <br><br>Code so that your app gracefully handles any future changes to this list.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\EbayBrowseClient\Model\TargetLocation|null
     */
     ...
     *
     * @param \OpenAPI\EbayBrowseClient\Model\TargetLocation|null $distance_from_pickup_location distance_from_pickup_location
     *
     * @return self
     */
     ...
     * Gets item_location
     *
     * @return \OpenAPI\EbayBrowseClient\Model\ItemLocationImpl|null
     */
     ...
     * Sets item_location
     *
     * @param \OpenAPI\EbayBrowseClient\Model\ItemLocationImpl|null $item_location item_location
     *
     * @return self
     */
     ...
     *
     * @param string|null $listing_marketplace_id The ID of the eBay marketplace where the seller listed the item. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/browse/types/ba:MarketplaceIdEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     * Gets pickup_options
     *
     * @return \OpenAPI\EbayBrowseClient\Model\PickupOptionSummary[]|null
     */
     ...
     * Sets pickup_options
     *
     * @param \OpenAPI\EbayBrowseClient\Model\PickupOptionSummary[]|null $pickup_options This container returns the local pickup options available to the buyer. This container is only returned if the user is searching for local pickup items and set the local pickup filters in the method request.
     *
     * @return self
     */
     ...
     * Gets seller
     *
     * @return \OpenAPI\EbayBrowseClient\Model\Seller|null
     */
     ...
     * Sets seller
     *
     * @param \OpenAPI\EbayBrowseClient\Model\Seller|null $seller seller
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\EbayBrowseClient\Model\ShippingOptionSummary[]|null
     */
     ...
     *
     * @param \OpenAPI\EbayBrowseClient\Model\ShippingOptionSummary[]|null $shipping_options This container returns the shipping options available to ship the item.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\EbayBrowseClient\Model\Image[]|null $thumbnail_images An array of thumbnail images for the item.
     *
     * @return self
     */
