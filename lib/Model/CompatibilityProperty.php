...
class CompatibilityProperty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets localized_name
     *
     * @param string|null $localized_name The name of the product attribute that as been translated to the language of the site.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the product attribute, such as Make, Model, Year, etc.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value The value for the <b> name</b> attribute, such as BMW, R1200GS, 2011, etc.
     *
     * @return self
     */
