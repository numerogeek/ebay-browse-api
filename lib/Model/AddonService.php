...
/**
 * AddonService Class Doc Comment
 *
 * @category Class
...
class AddonService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddonService';
    ...
    protected static $openAPITypes = [
        'selection' => 'string',
        'service_fee' => '\OpenAPI\EbayBrowseClient\Model\ConvertedAmount',
        'service_id' => 'string',
        'service_type' => 'string'
    ];
    ...
    */
     ...
     * Sets selection
     *
     * @param string|null $selection This field indicates whether the add-on service must be selected for the item. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/browse/types/gct:AddonServiceSelectionEnum'>eBay API documentation</a>
     *
     * @return self
     */
     ...
     * Sets service_fee
     *
     * @param \OpenAPI\EbayBrowseClient\Model\ConvertedAmount|null $service_fee service_fee
     *
     * @return self
     */
     ...
     * Sets service_id
     *
     * @param string|null $service_id The ID number of the add-on service.
     *
     * @return self
     */
     ...
     * Sets service_type
     *
     * @param string|null $service_type The type of add-on service, such as AUTHENTICITY_GUARANTEE. For implementation help, refer to <a href='https://developer.ebay.com/api-docs/buy/browse/types/gct:AddonServiceTypeEnum'>eBay API documentation</a>
     *
     * @return self
     */
