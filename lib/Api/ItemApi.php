...
namespace OpenAPI\EbayBrowseClient\Api;
...
use OpenAPI\EbayBrowseClient\ApiException;
use OpenAPI\EbayBrowseClient\Configuration;
use OpenAPI\EbayBrowseClient\HeaderSelector;
...
/**
     ...
     * @param  \OpenAPI\EbayBrowseClient\Model\CompatibilityPayload $compatibility_payload compatibility_payload (optional)
     ...
     *
     * @throws \OpenAPI\EbayBrowseClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayBrowseClient\Model\CompatibilityResponse
     */
    public function checkCompatibility($item_id, $x_ebay_c_marketplace_id, $compatibility_payload = null, string $contentType = self::contentTypes['checkCompatibility'][0])
    {
        list($response) = $this->checkCompatibilityWithHttpInfo($item_id, $x_ebay_c_marketplace_id, $compatibility_payload, $contentType);
        return $response;
    }
     ...
     * @param  string $item_id The eBay RESTful identifier of an item (such as a part you want to check). This ID is returned by the &lt;b&gt; Browse&lt;/b&gt; and &lt;b&gt; Feed&lt;/b&gt; API methods.  &lt;br&gt;&lt;br&gt; &lt;b&gt; RESTful Item ID Format: &lt;/b&gt;&lt;code&gt;v1&lt;/code&gt;|&lt;code&gt;&lt;i&gt;#&lt;/i&gt;&lt;/code&gt;|&lt;code&gt;&lt;i&gt;#&lt;/i&gt;&lt;/code&gt; &lt;br&gt;For example: &lt;code&gt;v1|2**********2|0&lt;/code&gt; or &lt;code&gt;v1|1**********2|4**********2&lt;/code&gt; &lt;br&gt;&lt;br&gt;For more information about item ID for RESTful APIs, see the &lt;a href&#x3D;\&quot;/api-docs/buy/static/api-browse.html#Legacy\&quot;&gt;Legacy API compatibility&lt;/a&gt; section of the &lt;i&gt;Buy APIs Overview&lt;/i&gt;. (required)
     * @param  string $x_ebay_c_marketplace_id The ID of the eBay marketplace you want to use. &lt;b&gt; Note: &lt;/b&gt; This value is case sensitive.&lt;br&gt;&lt;br&gt;For example: &lt;br&gt;&amp;nbsp;&amp;nbsp;&lt;code&gt;X-EBAY-C-MARKETPLACE-ID &#x3D; EBAY_US&lt;/code&gt;  &lt;br&gt;&lt;br&gt; For a list of supported sites see, &lt;a href&#x3D;\&quot;/api-docs/buy/browse/overview.html#API\&quot;&gt;API Restrictions&lt;/a&gt;. (required)
     * @param  \OpenAPI\EbayBrowseClient\Model\CompatibilityPayload $compatibility_payload (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['checkCompatibility'] to see the possible values for this operation
     *
     * @throws \OpenAPI\EbayBrowseClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayBrowseClient\Model\CompatibilityResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function checkCompatibilityWithHttpInfo($item_id, $x_ebay_c_marketplace_id, $compatibility_payload = null, string $contentType = self::contentTypes['checkCompatibility'][0])
    {
        $request = $this->checkCompatibilityRequest($item_id, $x_ebay_c_marketplace_id, $compatibility_payload, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayBrowseClient\Model\CompatibilityResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\EbayBrowseClient\Model\CompatibilityResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayBrowseClient\Model\CompatibilityResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayBrowseClient\Model\CompatibilityResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayBrowseClient\Model\CompatibilityResponse',
     ...
     */
    public function checkCompatibilityAsync($item_id, $x_ebay_c_marketplace_id, $compatibility_payload = null, string $contentType = self::contentTypes['checkCompatibility'][0])
    {
        return $this->checkCompatibilityAsyncWithHttpInfo($item_id, $x_ebay_c_marketplace_id, $compatibility_payload, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkCompatibilityAsyncWithHttpInfo($item_id, $x_ebay_c_marketplace_id, $compatibility_payload = null, string $contentType = self::contentTypes['checkCompatibility'][0])
    {
        $returnType = '\OpenAPI\EbayBrowseClient\Model\CompatibilityResponse';
        $request = $this->checkCompatibilityRequest($item_id, $x_ebay_c_marketplace_id, $compatibility_payload, $contentType);
     ...
     */
    public function checkCompatibilityRequest($item_id, $x_ebay_c_marketplace_id, $compatibility_payload = null, string $contentType = self::contentTypes['checkCompatibility'][0])
    {
     ...
     * @throws \OpenAPI\EbayBrowseClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayBrowseClient\Model\Item
     */
    public function getItem($item_id, $x_ebay_c_marketplace_id, $fieldgroups = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItem'][0])
    {
        list($response) = $this->getItemWithHttpInfo($item_id, $x_ebay_c_marketplace_id, $fieldgroups, $x_ebay_c_enduserctx, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\EbayBrowseClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayBrowseClient\Model\Item, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemWithHttpInfo($item_id, $x_ebay_c_marketplace_id, $fieldgroups = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItem'][0])
    {
        $request = $this->getItemRequest($item_id, $x_ebay_c_marketplace_id, $fieldgroups, $x_ebay_c_enduserctx, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayBrowseClient\Model\Item' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\EbayBrowseClient\Model\Item' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayBrowseClient\Model\Item', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayBrowseClient\Model\Item';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayBrowseClient\Model\Item',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getItemAsync($item_id, $x_ebay_c_marketplace_id, $fieldgroups = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItem'][0])
    {
        return $this->getItemAsyncWithHttpInfo($item_id, $x_ebay_c_marketplace_id, $fieldgroups, $x_ebay_c_enduserctx, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getItemAsyncWithHttpInfo($item_id, $x_ebay_c_marketplace_id, $fieldgroups = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItem'][0])
    {
        $returnType = '\OpenAPI\EbayBrowseClient\Model\Item';
        $request = $this->getItemRequest($item_id, $x_ebay_c_marketplace_id, $fieldgroups, $x_ebay_c_enduserctx, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getItemRequest($item_id, $x_ebay_c_marketplace_id, $fieldgroups = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItem'][0])
    {
        ...
        if ($x_ebay_c_marketplace_id === null || (is_array($x_ebay_c_marketplace_id) && count($x_ebay_c_marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ebay_c_marketplace_id when calling getItem'
            );
        }
     ...
     * @return \OpenAPI\EbayBrowseClient\Model\Item
     */
    public function getItemByLegacyId($legacy_item_id, $x_ebay_c_marketplace_id, $fieldgroups = null, $legacy_variation_id = null, $legacy_variation_sku = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItemByLegacyId'][0])
    {
        list($response) = $this->getItemByLegacyIdWithHttpInfo($legacy_item_id, $x_ebay_c_marketplace_id, $fieldgroups, $legacy_variation_id, $legacy_variation_sku, $x_ebay_c_enduserctx, $contentType);
        return $response;
    }
     ...
     * @return array of \OpenAPI\EbayBrowseClient\Model\Item, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemByLegacyIdWithHttpInfo($legacy_item_id, $x_ebay_c_marketplace_id, $fieldgroups = null, $legacy_variation_id = null, $legacy_variation_sku = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItemByLegacyId'][0])
    {
        $request = $this->getItemByLegacyIdRequest($legacy_item_id, $x_ebay_c_marketplace_id, $fieldgroups, $legacy_variation_id, $legacy_variation_sku, $x_ebay_c_enduserctx, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getItemByLegacyIdAsync($legacy_item_id, $x_ebay_c_marketplace_id, $fieldgroups = null, $legacy_variation_id = null, $legacy_variation_sku = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItemByLegacyId'][0])
    {
        return $this->getItemByLegacyIdAsyncWithHttpInfo($legacy_item_id, $x_ebay_c_marketplace_id, $fieldgroups, $legacy_variation_id, $legacy_variation_sku, $x_ebay_c_enduserctx, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getItemByLegacyIdAsyncWithHttpInfo($legacy_item_id, $x_ebay_c_marketplace_id, $fieldgroups = null, $legacy_variation_id = null, $legacy_variation_sku = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItemByLegacyId'][0])
    {
        $returnType = '\OpenAPI\EbayBrowseClient\Model\Item';
        $request = $this->getItemByLegacyIdRequest($legacy_item_id, $x_ebay_c_marketplace_id, $fieldgroups, $legacy_variation_id, $legacy_variation_sku, $x_ebay_c_enduserctx, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getItemByLegacyIdRequest($legacy_item_id, $x_ebay_c_marketplace_id, $fieldgroups = null, $legacy_variation_id = null, $legacy_variation_sku = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItemByLegacyId'][0])
    {
        ...
        if ($x_ebay_c_marketplace_id === null || (is_array($x_ebay_c_marketplace_id) && count($x_ebay_c_marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ebay_c_marketplace_id when calling getItemByLegacyId'
            );
        }
     ...
     * @throws \OpenAPI\EbayBrowseClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayBrowseClient\Model\Items
     */
    public function getItems($x_ebay_c_marketplace_id, $item_ids = null, $item_group_ids = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItems'][0])
    {
        list($response) = $this->getItemsWithHttpInfo($x_ebay_c_marketplace_id, $item_ids, $item_group_ids, $x_ebay_c_enduserctx, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\EbayBrowseClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayBrowseClient\Model\Items, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemsWithHttpInfo($x_ebay_c_marketplace_id, $item_ids = null, $item_group_ids = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItems'][0])
    {
        $request = $this->getItemsRequest($x_ebay_c_marketplace_id, $item_ids, $item_group_ids, $x_ebay_c_enduserctx, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayBrowseClient\Model\Items' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\EbayBrowseClient\Model\Items' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayBrowseClient\Model\Items', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayBrowseClient\Model\Items';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayBrowseClient\Model\Items',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getItemsAsync($x_ebay_c_marketplace_id, $item_ids = null, $item_group_ids = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItems'][0])
    {
        return $this->getItemsAsyncWithHttpInfo($x_ebay_c_marketplace_id, $item_ids, $item_group_ids, $x_ebay_c_enduserctx, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getItemsAsyncWithHttpInfo($x_ebay_c_marketplace_id, $item_ids = null, $item_group_ids = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItems'][0])
    {
        $returnType = '\OpenAPI\EbayBrowseClient\Model\Items';
        $request = $this->getItemsRequest($x_ebay_c_marketplace_id, $item_ids, $item_group_ids, $x_ebay_c_enduserctx, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getItemsRequest($x_ebay_c_marketplace_id, $item_ids = null, $item_group_ids = null, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItems'][0])
    {

        // verify the required parameter 'x_ebay_c_marketplace_id' is set
        if ($x_ebay_c_marketplace_id === null || (is_array($x_ebay_c_marketplace_id) && count($x_ebay_c_marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ebay_c_marketplace_id when calling getItems'
            );
        }
     ...
     * @throws \OpenAPI\EbayBrowseClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\EbayBrowseClient\Model\ItemGroup
     */
    public function getItemsByItemGroup($item_group_id, $x_ebay_c_marketplace_id, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItemsByItemGroup'][0])
    {
        list($response) = $this->getItemsByItemGroupWithHttpInfo($item_group_id, $x_ebay_c_marketplace_id, $x_ebay_c_enduserctx, $contentType);
        return $response;
    }
     ...
     * @throws \OpenAPI\EbayBrowseClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\EbayBrowseClient\Model\ItemGroup, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemsByItemGroupWithHttpInfo($item_group_id, $x_ebay_c_marketplace_id, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItemsByItemGroup'][0])
    {
        $request = $this->getItemsByItemGroupRequest($item_group_id, $x_ebay_c_marketplace_id, $x_ebay_c_enduserctx, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\EbayBrowseClient\Model\ItemGroup' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\EbayBrowseClient\Model\ItemGroup' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\EbayBrowseClient\Model\ItemGroup', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\EbayBrowseClient\Model\ItemGroup';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\EbayBrowseClient\Model\ItemGroup',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getItemsByItemGroupAsync($item_group_id, $x_ebay_c_marketplace_id, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItemsByItemGroup'][0])
    {
        return $this->getItemsByItemGroupAsyncWithHttpInfo($item_group_id, $x_ebay_c_marketplace_id, $x_ebay_c_enduserctx, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getItemsByItemGroupAsyncWithHttpInfo($item_group_id, $x_ebay_c_marketplace_id, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItemsByItemGroup'][0])
    {
        $returnType = '\OpenAPI\EbayBrowseClient\Model\ItemGroup';
        $request = $this->getItemsByItemGroupRequest($item_group_id, $x_ebay_c_marketplace_id, $x_ebay_c_enduserctx, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getItemsByItemGroupRequest($item_group_id, $x_ebay_c_marketplace_id, $x_ebay_c_enduserctx = null, string $contentType = self::contentTypes['getItemsByItemGroup'][0])
    {
        ...
        if ($x_ebay_c_marketplace_id === null || (is_array($x_ebay_c_marketplace_id) && count($x_ebay_c_marketplace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ebay_c_marketplace_id when calling getItemsByItemGroup'
            );
        }
