 ...
 */
class HazardStatement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HazardStatement';
    ...
    */
     ...
     *
     * @param string|null $statement_description A description of the nature of the hazard, such as whether the material is toxic if swallowed.
     *
     * @return self
     */
     ...
     * Sets statement_id
     *
     * @param string|null $statement_id The ID of the hazard statement.
     *
     * @return self
     */
