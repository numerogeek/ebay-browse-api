# OpenAPI\EbayBrowseClient\ItemApi
...
```php
checkCompatibility($item_id, $x_ebay_c_marketplace_id, $compatibility_payload): \OpenAPI\EbayBrowseClient\Model\CompatibilityResponse
```
...
| **compatibility_payload** | [**\OpenAPI\EbayBrowseClient\Model\CompatibilityPayload**](../Model/CompatibilityPayload.md)|  | [optional] |

### Return type

[**\OpenAPI\EbayBrowseClient\Model\CompatibilityResponse**](../Model/CompatibilityResponse.md)
...
```php
getItem($item_id, $x_ebay_c_marketplace_id, $fieldgroups, $x_ebay_c_enduserctx): \OpenAPI\EbayBrowseClient\Model\Item
```
...
try {
    $result = $apiInstance->getItem($item_id, $x_ebay_c_marketplace_id, $fieldgroups, $x_ebay_c_enduserctx);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\EbayBrowseClient\Model\Item**](../Model/Item.md)
...
```php
getItemByLegacyId($legacy_item_id, $x_ebay_c_marketplace_id, $fieldgroups, $legacy_variation_id, $legacy_variation_sku, $x_ebay_c_enduserctx): \OpenAPI\EbayBrowseClient\Model\Item
```
...
try {
    $result = $apiInstance->getItemByLegacyId($legacy_item_id, $x_ebay_c_marketplace_id, $fieldgroups, $legacy_variation_id, $legacy_variation_sku, $x_ebay_c_enduserctx);
    print_r($result);
} catch (Exception $e) {
...
```php
getItems($x_ebay_c_marketplace_id, $item_ids, $item_group_ids, $x_ebay_c_enduserctx): \OpenAPI\EbayBrowseClient\Model\Items
```
...
try {
    $result = $apiInstance->getItems($x_ebay_c_marketplace_id, $item_ids, $item_group_ids, $x_ebay_c_enduserctx);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\EbayBrowseClient\Model\Items**](../Model/Items.md)
...
```php
getItemsByItemGroup($item_group_id, $x_ebay_c_marketplace_id, $x_ebay_c_enduserctx): \OpenAPI\EbayBrowseClient\Model\ItemGroup
```
...
try {
    $result = $apiInstance->getItemsByItemGroup($item_group_id, $x_ebay_c_marketplace_id, $x_ebay_c_enduserctx);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\EbayBrowseClient\Model\ItemGroup**](../Model/ItemGroup.md)
