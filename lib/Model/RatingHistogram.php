...
/**
 * RatingHistogram Class Doc Comment
 *
 * @category Class
 ...
 */
class RatingHistogram implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RatingHistogram';
    ...
    */
     ...
     * Sets count
     *
     * @param int|null $count The total number of user ratings that the product has received.
     *
     * @return self
     */
     ...
     * Sets rating
     *
     * @param string|null $rating This is the average rating for the product. As part of a product review, users rate the product. Products are rated from one star (terrible) to five stars (excellent), with each star having a corresponding point value - one star gets 1 point, two stars get 2 points, and so on. If a product had one four-star rating and one five-star rating, its average rating would be <code> 4.5</code>, and this is the value that would appear in this field.
     *
     * @return self
     */
