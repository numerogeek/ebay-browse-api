...
class ShipToLocations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'region_excluded' => '\OpenAPI\EbayBrowseClient\Model\ShipToRegion[]',
    ...
    {
        $this->setIfExists('region_excluded', $data ?? [], null);
        $this->setIfExists('region_included', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \OpenAPI\EbayBrowseClient\Model\ShipToRegion[]|null
     */
     ...
     *
     * @param \OpenAPI\EbayBrowseClient\Model\ShipToRegion[]|null $region_excluded An array of containers that express the large geographical regions, countries, state/provinces, or special locations within a country where the seller is not willing to ship to.
     *
     * @return self
     */
    public function setRegionExcluded($region_excluded)
    {
        if (is_null($region_excluded)) {
            throw new \InvalidArgumentException('non-nullable region_excluded cannot be null');
        }
     ...
     *
     * @param \OpenAPI\EbayBrowseClient\Model\ShipToRegion[]|null $region_included An array of containers that express the large geographical regions, countries, or state/provinces within a country where the seller is willing to ship to. Prospective buyers must look at the shipping regions under this container, as well as the shipping regions that are under the <b>regionExcluded</b> to see where the seller is willing to ship items. Sellers can specify that they ship 'Worldwide', but then add several large geographical regions (e.g. Asia, Oceania, Middle East) to the exclusion list, or sellers can specify that they ship to Europe and Africa, but then add several individual countries to the exclusion list.
     *
     * @return self
     */
    public function setRegionIncluded($region_included)
    {
        if (is_null($region_included)) {
            throw new \InvalidArgumentException('non-nullable region_included cannot be null');
        }
