...
/**
 * PickupOptionSummary Class Doc Comment
 *
 * @category Class
 ...
 */
class PickupOptionSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PickupOptionSummary';
    ...
    {
        $this->setIfExists('pickup_location_type', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $pickup_location_type This container returns the local pickup options available to the buyer. Possible values are <code>ARRANGED_LOCATION</code> and <code>STORE</code>.
     *
     * @return self
     */
    public function setPickupLocationType($pickup_location_type)
    {
        if (is_null($pickup_location_type)) {
            throw new \InvalidArgumentException('non-nullable pickup_location_type cannot be null');
        }
