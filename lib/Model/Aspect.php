...
class Aspect implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('localized_values', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets localized_name
     *
     * @param string|null $localized_name The text representing the name of the aspect for the name/value pair, such as Brand.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $localized_values The text representing the value of the aspect for the name/value pair, such as Apple.
     *
     * @return self
     */
    public function setLocalizedValues($localized_values)
    {
        if (is_null($localized_values)) {
            throw new \InvalidArgumentException('non-nullable localized_values cannot be null');
        }
