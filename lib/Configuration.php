...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.ebay.com/buy/browse/v1';
    ...
    {
        $report  = 'PHP SDK (OpenAPI\EbayBrowseClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: v1.18.4' . PHP_EOL;
